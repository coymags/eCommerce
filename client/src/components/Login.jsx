            ...
            <div className='w-[50%] h-[70%] md:w-[40%]'>
                <form onSubmit={handleOnSubmit}>
                    <div className='flex flex-col w-[full] h-[5rem]'>
                        ...
                        <input required type="text" name='email' className={emailError ? "w-full px-3 py-2 border-2 border-red-600 rounded-md " :"w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500"} onChange={handleOnChange} onClick={() => setEmailError(false)}/>
                    </div>
                    <div className='flex flex-col w-[full] h-[5rem]'>
                        <label htmlFor="" className='font-bold'>Repeat Password:</label>
                        <div className='relative'>
                            <input required type={togglePass ? 'password' : 'text'} name='password' className={emailError ? "w-full px-3 py-2 border-2 border-red-600 rounded-md":"w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500"} placeholder="Enter password" onChange={handleOnChange}/>

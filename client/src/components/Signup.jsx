          ...
          <div className='w-[50%] h-[70%] md:w-[40%]'>
            <form onSubmit={handleOnSubmit}>
              <div className='flex flex-col w-[full] h-[5rem]'>
                ...
                <input type="text" value={RegisterInput.email} name='email' className="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500" onChange={handleOnChange}/>
              </div>
              {/*<div className='flex flex-col w-[full] h-[5rem]'>
